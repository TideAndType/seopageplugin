	...
	public function render_seo_panel( $post ) {
		...
		<div class="scc-panel" data-post-id="<?php echo esc_attr( $post->ID ); ?>">
			...
			<div class="scc-panel__actions">
				<button type="button" class="button button-primary" id="scc-panel-smart"><?php esc_html_e( 'Smart SEO', 'seo-command-center' ); ?></button>
				<button type="button" class="button" id="scc-panel-optimize"><?php esc_html_e( 'Technical optimize', 'seo-command-center' ); ?></button>
