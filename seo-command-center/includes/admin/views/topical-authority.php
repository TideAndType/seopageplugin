			...
			<div class="scc-card">
				...
				<table class="scc-ta-totals">
					<tbody>
						...
						<tr><td><?php esc_html_e( 'Possible cannibalization', 'seo-command-center' ); ?></td><td><strong><?php echo esc_html( number_format_i18n( (int) ( $t['cannibalization'] ?? 0 ) ) ); ?></strong> <a class="scc-note" href="<?php echo esc_url( admin_url( 'admin.php?page=seo-command-center#doctor-content' ) ); ?>"><?php esc_html_e( 'review', 'seo-command-center' ); ?></a></td></tr>
